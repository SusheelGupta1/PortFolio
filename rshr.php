...
<body><br>
  ...
  <div class="card" style="width:100%">
    <img src="img/rshr1.jpg" class="card-img-top" alt="rshr" >
    <div class="card-body">
      <h2 class="card-title"><u><b>Expercience Details</b></u></h2>
      <p class="card-text">In this profile I have 1 year expercience and my work profile is hr recuirter<br> we providing the job offer to the bikes .<br> like that for swiggy, amazon,zomato we also provide the bigbasket job offer .<br> In this profile age limite will be limited 20 to 55 age can get only offer <br>and i left the job beacuse my college was reopen <br>i want formward my study continue so thats why i left the job</p>
    </div>
