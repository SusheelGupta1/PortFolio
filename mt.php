...
<div class="card-deck">
  ...
  <div class="card">
    <img src="img/merit.png" class="card-img-top" alt="...">
    <div class="card-body">
      <h2 class="card-title"><u><b>Expercience Details</b></u></h2>
      <p class="card-text">In this profile i have 6 month expercience.<br> In this profile my position is server manager.<br> We conducting the goverment exam like-: MH-CET,AIMA,PCM etc...<br> and I managing the server and exam all arrangement. <br>and we also setup the server in all laptop.<br> and formating the laptop. and we also solve the issue when any customer facing the issue.<br>this is a tempory type job so thats why i left the job.... </p>
    </div>
