...
<div class="card-deck">
  ...
  <div class="card">
    <img src="img/wtc.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h2 class="card-title"><u><b>Expercience Details</b></u></h2>
      <p class="card-text">In this profile I am currently working in this organisation .<br> In this profile my postion is Custome Support Engineer .<br> I managing the server. and AIO if any clint facing the issue I solve the probleam. <br>like-pc hanging, network issue, printer installation, and OS Installation etc...</p>
    </div>
