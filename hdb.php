...
<div class="card-deck">
  ...
  <div class="card">
    <img src="img/hdb.jpg" class="card-img-top" alt="..." align="center">
    <div class="card-body">
      <h2 class="card-title"><u><b>Expercience Details</b></u></h2>
      <p class="card-text">In this profile I have 1 year exepercience.<br>and my position is sales recuiter officer .<br>and my work profile is we have providing the loan without any documents.<br> beacause this loan is related to credit card offer . .<br>the loan name is Insta loan Jumbo loan we also updating the credit card for example .<br>if you have lower lever credit card if you have offer to update the card .<br>then we can process all the call are recordable..<br> we also increase the the credit card limite..<br> I left the job because I want start my career in I.T profile thats why i resign from this position  </p>
    </div>
